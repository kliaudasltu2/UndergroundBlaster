...
public class Artist extends Helper{

    private final TextureAtlas atlas;

    public Artist(PlayScreen screen, float x, float y, boolean canwalk){
        ...
        walking[0] = createAnimation("arWalkBack", false);
        walking[1] = createAnimation("arWalkFront", false);
        walking[2] = createAnimation("arWalkSide", false);
        walking[3] = createAnimation("arWalkSide", true);

        waving = new Animation[4];
        waving[0] = createAnimation("arGreetingsBack", false);
        waving[1] = createAnimation("arGreetingsFront", false);
        waving[2] = createAnimation("arGreetingsSide", false);
        waving[3] = createAnimation("arGreetingsSide", true);
